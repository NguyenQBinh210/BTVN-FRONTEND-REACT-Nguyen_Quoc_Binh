...
const Footer = () => {
  return (
    <footer className="mt-32 w-full  flex items-center justify-center bg-gray-800" >
      <div className="max-w-lg mx-auto w-[80%]">
        ...
        <div className="text-center pb-16 pt-5">
          ...
          <div className="px-5 sm:px-0 flex flex-col sm:flex-row sm:space-x-3 space-y-3 sm:space-y-0 justify-center mt-3">
            <input
              ...
              className="rounded-full py-2 pl-5 border border-gray-400 bg-gray-300"
            />
            <button
              type="submit"
        ...
        <div className="text-center text-white">
          <p className="my-3 text-gray-400 text-sm">
            &copy; 2021 className Technologies Inc.
          </p>
